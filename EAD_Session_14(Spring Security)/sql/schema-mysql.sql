...
create table authorities (
 ...
 insert into authorities(username,authority)values('aman','ROLE_ADMIN');
 
  insert into users(username, password, enabled)values('employee','employee',true);
 insert into authorities(username,authority)values('aman123','ROLE_USER');
...
truncate table authorities;
 ...
 insert into authorities(username,authority)values('user1234','ROLE_USER');

  insert into users(username, password, enabled)values('svk','12345',true);
 insert into authorities(username,authority)values('user_user','ROLE_USER');
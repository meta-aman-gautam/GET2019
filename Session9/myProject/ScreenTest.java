...
import myProject.Shape.ShapeType;
...
public class ScreenTest {
     ...
     */
    @Test
    public void testForAddNullShape() {
    ...
    @SuppressWarnings("serial")
    @Test
    public void testForAddShape_OutsideScreen() {
    ...
    @SuppressWarnings("serial")
    @Test
    public void testForDeleteShape() {
    ...
    @SuppressWarnings("serial")
    @Test
    public void testForDeleteShape_OutsideScreen() {
    ...
    /**
     * test case to remove all shapes of a particular type from the screen when objects
     *  of that type are present
     */
    @SuppressWarnings("serial")
    @Test
    public void testForDeleteAllShape() {
    ...
    /**
     * test case to remove all shapes of a particular type from the screen when no object 
     * of that type are present
     */
    @SuppressWarnings("serial")
    @Test
    public void testForDeleteAllShape_ShapeNotPresent() {
    ...
    public void testForSortByArea_EmptyList_AssertionError() {
    ...
    @SuppressWarnings("serial")
    @Test
    public void testForSortByPerimeter() {
     ...
     */
    @Test(expected = AssertionError.class)
    public void testForSortByPerimeter_EmptyList_AssertionError() {
    ...
    @SuppressWarnings("serial")
    @Test
    public void testForSortByOriginDistance() {
     ...
     */
    @Test(expected = AssertionError.class)
    public void testForSortByOriginDistance_AssertionError() {
    ...
    @SuppressWarnings("serial")
    @Test
    public void testForSortByTimeStamp() {
     ...
     */
    @Test(expected = AssertionError.class)
    public void testForSortByTimeStamp_AssertionError() {
